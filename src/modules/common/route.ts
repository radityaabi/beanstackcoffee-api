...
commonRoute.get("/", (c) => {
  return c.json({
    ...
    message:
      "Welcome to the Beanstack Coffee API! Explore our endpoints to discover a variety of coffee products, including details such as categories, brands, prices, and flavor profiles. Use the /products endpoint to browse all products or /products/:slug to get information about a specific product.",
    description:
